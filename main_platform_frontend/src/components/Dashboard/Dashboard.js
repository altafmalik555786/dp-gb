                            ...
                            <div className="row">
                                <div className="col-lg-12 mb-4">
                                    <div className="alert alert-success alert-dismissible fade show p-3" role="alert">
                                        Congratulations! Your listing <strong>Hotel Govendor</strong> has been approved!
                                    ...
                                    <div className="card-item dashboard-stat">
                                        <div className="card-content">
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <h2 className="card-title font-size-40">10</h2>
                                                    <p className="card-sub font-size-18 line-height-24">Active Listings</p>
                                                </div>
                                        ...
                                        <div className="card-content">
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    ...
                                                    <p className="card-sub font-size-18 line-height-24">Total Reviews</p>
                                                </div>
                                                <div className="col-auto font-size-60">
                                        ...
                                        <div className="block-card-header d-flex flex-wrap align-items-center justify-content-between">
                                            <div id="myChartLegend">
                                                <ul className="0-legend d-flex align-items-center">
                                                    <li className="btn-gray mr-2"><span></span>Listings Views</li>
                                                    <li className="btn-gray"><span></span>Bookings</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div className="block-card-body">
                                            <div className="generic-list-card d-flex align-items-center justify-content-between">
                                                <div className="generic-list-card-content d-flex align-items-center mr-2">
                                                    <span className="icon-element bg-1 mr-2 after-none"><i className="la la-check"></i></span>
                                                    <span className="font-weight-medium font-size-15">Your listing <a href="#" className="generic-link">Hotel Gulshan</a> has been approved!</span>
                                                </div>
                                                <a href="javascript:void(0)" className="generic-close"><i className="la la-times"></i></a>
                                            </div>
                                            {/* <!-- end generic-list-card --> */}
                                            <div className="generic-list-card d-flex align-items-center justify-content-between">
                                                <div className="generic-list-card-content d-flex align-items-center mr-2">
                                                    <span className="icon-element bg-2 mr-2 after-none"><i className="la la-check"></i></span>
                                                    <span className="font-weight-medium font-size-15">Your listing <a href="#" className="generic-link">Burger House</a> has been approved!</span>
                                                </div>
                                                <a href="javascript:void(0)" className="generic-close"><i className="la la-times"></i></a>
                                            </div>
                                            {/* <!-- end generic-list-card --> */}
                                            <div className="generic-list-card d-flex align-items-center justify-content-between">
                                                <div className="generic-list-card-content d-flex align-items-center mr-2">
                                                    <span className="icon-element bg-3 mr-2 after-none"><i className="la la-star-o"></i></span>
                                                    <span className="font-weight-medium font-size-15">Pitter Parker left a review <span className="badge badge-warning text-white">3.4</span> on <a href="#" className="generic-link">John's Coffee Shop</a></span>
                                                </div>
                                                <a href="javascript:void(0)" className="generic-close"><i className="la la-times"></i></a>
                                            </div>
                                            {/* <!-- end generic-list-card --> */}
                                            <div className="generic-list-card d-flex align-items-center justify-content-between">
                                                <div className="generic-list-card-content d-flex align-items-center mr-2">
                                                    <span className="icon-element bg-4 mr-2 after-none"><i className="la la-bookmark"></i></span>
                                                    <span className="font-weight-medium font-size-15">Someone bookmarked your <a href="#" className="generic-link">Super Duper Burgers</a></span>
                                                </div>
                                                <a href="javascript:void(0)" className="generic-close"><i className="la la-times"></i></a>
                                            </div>
                                            {/* <!-- end generic-list-card --> */}
                                            <div className="generic-list-card d-flex align-items-center justify-content-between">
                                                <div className="generic-list-card-content d-flex align-items-center mr-2">
                                                    <span className="icon-element bg-5 mr-2 after-none"><i className="la la-star-o"></i></span>
                                                    <span className="font-weight-medium font-size-15">Alex Smith left a review <span className="badge badge-warning text-white">4.4</span> on <a href="#" className="generic-link">Tom's Restaurant</a></span>
                                                </div>
                                                <a href="javascript:void(0)" className="generic-close"><i className="la la-times"></i></a>
                                            </div>
                                            {/* <!-- end generic-list-card --> */}
                                ...
                                <div className="col-lg-7">
                                    <div className="block-card dashboard-card mb-4 px-0">
                                        <div className="block-card-header d-flex flex-wrap align-items-center justify-content-between px-4 border-bottom-0 pb-0">
                                            ...
                                            <a href="#" className="btn-gray">View More <i className="la la-arrow-right ml-1"></i></a>
                                        </div>
                                        <div className="block-card-body">
                                    ...
                                    <div className="block-card dashboard-card mb-4 px-0 pb-0">
                                        ...
                                        <div className="block-card-body pt-0">
                                            <div className="generic-list msg-from-customer">
                                                ...
                                                <a className="dropdown-item text-center small text-gray font-weight-medium py-2" href="dashboard-messages.html">View More <i className="la la-arrow-right ml-1"></i></a>
                                            </div>
                                            {/* <!-- end generic-list --> */}
                                        </div>
                                        {/* <!-- end block-card-body --> */}
