                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="filter-bar d-flex flex-wrap justify-content-between align-items-center margin-bottom-30px">
                                <p className="result-text font-weight-medium">Showing 1 to 10 of 30,590 entries</p>
                                <div className="filter-bar-action d-flex flex-wrap align-items-center">
                                    ...
                                    <ul className="filter-nav ml-1">
                                        ...
                                        <li><a href="listing-list.html" data-toggle="tooltip" data-placement="top" title="List View" className="active"><span className="la la-list"></span></a></li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-lg-8">
                            <div className="row">
                                {
                                    filteredCategory?.map(item => (<div className="col-lg-12">
                                        <div className="card-item card-item-list">
                                            <div className="card-image">
                                                <Link to="/listing-details" className="d-block">
                                                    <img src={item?.image ? item?.image : img4} data-src={item?.image ? item?.image : img4} className="card__img lazy" alt="" />
                                            ...
                                            <div className="card-content">
                                                <a href="#" className="user-thumb d-inline-block" data-toggle="tooltip" data-placement="top" title="TechyDevs">
                                                    <img src={item?.icon ? item?.icon : listingLogo} alt="author-img" />
                                                </a>
                                                ...
                                                <p className="card-sub"><a href="#"><i className="la la-map-marker mr-1 text-color-2"></i>{item?.address ? item?.address : 'N/A'}</a></p>
                                                <ul className="listing-meta d-flex align-items-center">
                                                    ...
                                                    <li className="d-flex align-items-center">
                                                        <i className="la la-cutlery mr-1 listing-icon"></i><a href="#" className="listing-cat-link">{item?.business_type ? item?.business_type : 'N/A'}</a>
                                                    </li>
                                                </ul>
                                    ...
                                    <div className="collapse collapse-content pb-3" id="moreOptionCollapse">
                                        <div className="d-flex align-items-center pb-4">
                                            ...
                                            <div className="date-form form-group mb-0 ml-3">
                                                ...
                                                <input className="date-dropper-input form-control form-control-sm" type="text" name="daterange" placeholder="Search by date" />
                                            </div>
