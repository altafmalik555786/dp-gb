    ...
    return (
        <div>
            <header className="header-area">
                <div className="header-top-bar py-2 padding-right-30px padding-left-30px border-bottom border-bottom-color">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-6 d-flex align-items-center header-top-info">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="menu-full-width">
                                    ...
                                    {/* <!-- end logo --> */}
                                    <div className="main-menu-content pr-0 padding-left-40px">
                                    ...
                                    <div className="quick-search-form d-flex align-items-center ml-auto">
...
================================= --> */}
            <section className="hero-wrapper hero-bg-5 padding-bottom-140px">
                        ...
                        <div className="col-lg-5 mr-auto">
                            <div className="main-search-input flex-column mt-0">
                                ...
                                <div className="main-search-input-item w-100 ml-0">
                                    ...
                                    <button className="theme-btn gradient-btn border-0 w-100 hover-scale-2" type="submit"><i className="la la-search mr-2"></i>Search Now</button>
                                </div>
                                {/* <!-- end main-search-input-item --> */}
                            </div>
                        ...
                        <div className="col-lg-6">
                            <div className="hero-heading">
                                <div className="section-heading">
                                    <h2 className="sec__title font-size-35">Discover Best Activities or click on the suggestions below.</h2>
                                </div>
                            </div>
                            {/* <!-- end hero-heading --> */}
                            <div className="highlight-lists row padding-top-40px">
                                <div className="col-lg-4 responsive-column">
                                    <div className="hero-category-item w-auto mb-4 hover-scale-2">
                                        <a href="#" className="d-block hero-cat-link hero-cat-link-2">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4">
                            <div className="card-heading-content mt-0">
                                <div className="section-heading">
                                    <h2 className="sec__title gradient-text">Check out Our Latest Listings.</h2>
                                    <p className="sec__desc">
                                        Morbi convallis bibendum urna ut viverra. Maecenas quis consequat libero,
                                        a feugiat eros. Nunc tortors.
                                    </p>
                                </div>
                                {/* <!-- end section-heading --> */}
                                <div className="more-btn-box pt-4">
                                    <a href="listing-grid.html" className="theme-btn gradient-btn hover-scale-2"><i className="la la-list-alt mr-1"></i>View All listings</a>
                                </div>
                            </div>
                        </div>
                        {/* <!-- end col-lg-4 --> */}
...
================================= --> */}
            <section className="card-area position-relative section-padding overflow-hidden">
                ...
                <div className="svg-bg svg-bg-4 gradient-bg-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
                        ...
                        <path fill-opacity="0.2" d="M761.9,40.6L643.1,24L333.9,93.8L0.1,1H0v99h1000V1"></path>
                    </svg>
                </div>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="card-heading-content text-center mt-0">
                                <div className="section-heading">
                                    <h2 className="sec__title gradient-text">Explore Most Popular Cities.</h2>
                                    <p className="sec__desc">
                                        Explore most popular destination and places, Morbi convallis bibendum urna <br />
                    ...
                    <div className="row padding-top-60px">
                        <div className="col-lg-3 responsive-column">
                            <div className="category-item category-item-layout-2 category-item-layout--2 hover-scale-2">
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="category-item category-item-layout-2 category-item-layout--2 hover-scale-2">
                                <img src={img6} data-src={img6} alt="category-image" className="cat-img lazy cat-img-height-2" />
                                <div className="category-content">
                                    <a href="#" className="category-link d-flex align-items-end w-100 h-100 text-left">
                                        <div className="category-content-inner d-flex align-items-center justify-content-between">
                                            <div>
                    ...
                    <div className="more-btn-box pt-4 text-center">
                        <a href="all-locations.html" className="theme-btn gradient-btn hover-scale-2"><i className="la la-globe mr-2"></i>View All Cities</a>
                    </div>
                </div>
                {/* <!-- end container --> */}
            </section>
...
<!-- ================================
    START FUN-FACT AREA
================================= --> */}
            <section className="funfact-area intro-bg bg-fixed position-relative section--padding">
                <div className="overlay opacity-9"></div>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item counter-item-layout-2">
                                <div className="counter-icon section-icon flex-shrink-0">
                                    <svg className="svg-icon-white" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 438.891 438.891" >
                                        <g>
                                ...
                                <div className="counter-content">
                                    <h3 className="counter__number text-white mb-2">
                                        <span className="counter">40,000</span>
                                        <span className="count-symbol">+</span>
                                    </h3>
                                    <p className="counter__title text-white-50">Listings Pages</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item counter-item-layout-2">
                                <div className="counter-icon section-icon flex-shrink-0">
                                    <svg className="svg-icon-white" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" >
                                        <g>
                                ...
                                <div className="counter-content">
                                    ...
                                    <p className="counter__title text-white-50">Happy Clients</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item counter-item-layout-2">
                                <div className="counter-icon section-icon flex-shrink-0">
                                    <svg className="svg-icon-white" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="counter-content">
                                    ...
                                    <p className="counter__title text-white-50">Company Joined</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item counter-item-layout-2">
                                ...
                                <div className="counter-content">
                                    ...
                                    <p className="counter__title text-white-50">Five Star Ratings</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
...
================================= --> */}
            <section className="hiw-area section--padding ">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-12">
                            <div className="section-heading text-center">
                                <div className="single-video-btn-box">
                    ...
                    {/* <!-- end row --> */}
                    <div className="row hiw-info-box-wrap position-inherit bottom-auto padding-top-60px">
                        <div className="col-lg-3 responsive-column">
            ...
            <section className="blog-area section--padding">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-heading text-center">
                                <h2 className="sec__title gradient-text">Articles You Might Like.</h2>
                                <p className="sec__desc">
                    ...
                    <div className="row padding-top-60px">
                        <div className="col-lg-4 responsive-column">
                            <div className="card-item card-item-layout-5">
                                <div className="card-image">
                                    <img src={img26} className="card__img" alt="blog image" />
                        ...
                        <div className="col-lg-4 responsive-column">
                            <div className="card-item card-item-layout-5">
                                <div className="card-image">
                                    <img src={img27} className="card__img" alt="blog image" />
                                ...
                                <div className="card-content">
                                    <ul className="listing-meta d-flex align-items-center pt-0">
                                        <li>
                                            <a href="#" className="listing-cat-link">Beauty</a>,
                                            <a href="#" className="listing-cat-link">News</a>
                                        </li>
                                    </ul>
                                    <h4 className="card-title pt-2">
                                        <a href="blog-single.html">The most defining beauty moments of 2019</a>
                                    </h4>
                                    <div className="avatar-photos pt-4">
                        ...
                        <div className="col-lg-4 responsive-column">
                            <div className="card-item card-item-layout-5">
                                <div className="card-image">
                                    <img src={img28} className="card__img" alt="blog image" />
...
<!-- ================================
    START CTA AREA
================================= --> */}
            <section className="cta-area padding-bottom-80px text-center position-relative">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="cta-content p-0">
                                ...
                                {/* <!-- end section-heading --> */}
                                <div className="btn-box padding-top-40px">
                                    <a href="#" className="theme-btn gradient-btn hover-scale-2" data-toggle="modal" data-target="#signUpModal"><i className="la la-user-plus mr-2"></i>Click Me to Start</a>
                                </div>
                                {/* <!-- end btn-box --> */}
                            </div>
                        </div>
                ...
                {/* <!-- end container --> */}
                <div className="svg-bg svg-bg-3 z-index-negative">
                    <svg className="h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="#F5F7FC" fill-opacity="1" d="M0,256L48,229.3C96,203,192,149,288,154.7C384,160,480,224,576,218.7C672,213,768,139,864,128C960,117,1056,171,1152,197.3C1248,224,1344,224,1392,224L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                    </svg>
                </div>
            </section>
            {/* <!-- end cta-area --> */}
...
<!-- ================================
       START FOOTER AREA
================================= --> */}
            <section className="footer-area bg-gray pattern-bg-2 padding-top-30px padding-bottom-30px">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-8">
                            <ul className="list-items term-list">
                                <li><a href="terms-and-conditions.html">Terms & Conditions</a></li>
                                <li><a href="privacy-policy.html">Privacy Policy</a></li>
                            </ul>
                        </div>
                        <div className="col-lg-4 text-right">
                            <ul className="social-profile social-profile-styled">
                                ...
                                <li><a href="#" className="behance-bg" data-toggle="tooltip" data-placement="top" title="Behance"><i className="lab la-behance"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="row pt-4">
                        <div className="col-lg-12">
                            <div className="cta-content d-flex align-items-center justify-content-between p-0">
                                <div className="section-heading">
                                    <h2 className="sec__title mb-0 font-size-24 line-height-30">Get the latest updates first!</h2>
