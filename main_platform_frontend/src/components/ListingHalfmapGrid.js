...
import ListingHeader2 from './ListingHeader2'
...
function ListingHalfmapGrid() {
  return (
    <div>
      <ListingHeader2 />
      <section className="breadcrumb-area bg-gradient-gray py-4">
        <div className="container-fluid padding-right-40px padding-left-40px">
          <div className="row">
            <div className="col-lg-12">
              <div className="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                <div className="section-heading">
                  <h2 className="sec__title font-size-26 mb-0">Listing Half Map Grid</h2>
                </div>
                <ul className="list-items bread-list bread-list-2 ">
                  <li><Link to="/">Home</Link></li>
                  <li>Listings</li>
                  <li>Listing Half Map Grid</li>
                </ul>
              </div>
...
================================= --> */}
      <section className="full-screen-container d-flex">
        <div className="w-50 card-area">
          <div className="filter-bar-wrap padding-left-30px padding-right-30px">
            <div className="filter-bar d-flex flex-wrap justify-content-between align-items-center shadow-none rounded-0 border-0 px-0">
              <p className="result-text font-weight-medium">Showing 1 to 6 of 98 entries</p>
            ...
            <form method="post" className="form-box row py-4">
              ...
              <div className="col-lg-12 more-options-box">
                <div className="collapse collapse-content pb-3" id="moreOptionCollapse">
                  ...
                  <div className="pb-4">
                    ...
                    <div className="checkbox-wrap row pt-3">
                  ...
                  <div className="pb-4">
                    <h3 className="font-size-16 font-weight-semi-bold">Filter by Neighborhoods</h3>
                    <div className="checkbox-wrap row pt-3">
                      <div className="col-lg-3 custom-checkbox">
                  ...
                  <div className="pb-4">
                    <h3 className="font-size-16 font-weight-semi-bold">Filter by Ratings</h3>
                    <ul className="custom-radio row pt-3">
                      <li className="d-flex align-items-center col-lg-2 pt-0">
                  ...
                  {/* <!-- end pb-4 --> */}
                  <div>
                    <h3 className="font-size-16 font-weight-semi-bold">Distance</h3>
                    <div className="checkbox-wrap row pt-3">
                      <div className="col-lg-3 custom-checkbox">
              ...
              <div className="col-lg-12 btn-box padding-top-30px">
                <button type="submit" className="theme-btn gradient-btn border-0">
          ...
          {/* <!-- end filter-bar-wrap --> */}
          <div className="row pt-4 padding-left-30px padding-right-30px">
            <div className="col-lg-6 responsive-column-lg">
          ...
          {/* <!-- end row --> */}
          <div className="row">
            <div className="col-lg-12 pt-3 text-center pb-5">
        ...
        {/* <!-- end card-area --> */}
        <div className="w-50 home-map">
          <div className="map-container height-980" >
            <div id="myMap"></div>
            <a href="#" className="enable-scroll" title="Enable or disable scrolling on map">
...
export default ListingHalfmapGrid