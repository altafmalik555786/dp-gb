                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="breadcrumb-content">
                                ...
                                <a
                                    className="btn-gray hover-scale mt-1"
                                    href="https://www.youtube.com/watch?v=GlrxcuEDyF8"
                                    data-fancybox=""
                                >
                                    <span className="la la-youtube-play mr-2"></span>Watch the video
                                </a>
                            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 responsive-column">
                            <a
                                href="career.html"
                                className="card-item card-item-layout-2 d-block hover-scale-2"
                            >
                        ...
                        <div className="col-lg-4 responsive-column">
                            ...
                            >
                                ...
                                {/* <!-- end card-image --> */}
                                <div className="card-content">
                                    <h4 className="card-title">Newsroom</h4>
                                    <p className="card-sub mt-3">
                                        Ut euismod ultricies sollicitudin. Curabitur sed dapibus
                                        nulla. Nulla eget iaculis.
                                    </p>
                        ...
                        <div className="col-lg-4 responsive-column">
                            ...
                            >
                                ...
                                {/* <!-- end card-image --> */}
                                <div className="card-content">
                                    <h4 className="card-title">Investor Relations</h4>
                                    <p className="card-sub mt-3">
                                        Ut euismod ultricies sollicitudin. Curabitur sed dapibus
                                        nulla. Nulla eget iaculis.
                                    </p>
...
================================= --> */}
            <section className="about-area padding-bottom-100px">
                <div className="container">
                    <div className="row padding-bottom-100px align-items-center">
                            ...
                            <div className="about-content mt-0">
                                <div className="section-heading">
                                    ...
                                    <p className="sec__desc pb-3">
                                        ...
                                        in mauris quis libero sodales eleifend.
                                    </p>
                                ...
                                <div className="btn-box padding-top-30px">
                                    ...
                                    >Find out More<i className="la la-arrow-right ml-2"></i
                                    ></a>
                                </div>
                                {/* <!-- end btn-box --> */}
                            </div>
                    ...
                    <div className="row section-padding">
                        ...
                        {/* <!-- end col-lg-6 --> */}
                        <div className="col-lg-6">
                            <div className="about-content pl-4 mb-0">
                                <div className="section-heading">
                                    <div className="section-badge pb-3">
                                        <span className="ribbon ribbon-2 bg-2 text-white"
                                        >Our Mission</span
                                    ...
                                    <p className="sec__desc pb-3">
                                        An online marketplace (or online e-commerce marketplace) is a
                                        type of e-commerce site where product and inventory
                                        information is provided by multiple third parties, whereas
                    ...
                    {/* <!-- end row --> */}
                    <div className="section-block"></div>
                    <div className="row padding-top-90px">
                        <div className="col-lg-10 mx-auto">
                            <div className="about-content text-center">
                                <div className="section-heading">
                                    <h2 className="sec__title">Serving Your Community</h2>
                                    <p className="sec__desc">
                                        Efficiently unleash cross-media information without
                                        cross-media value. Quickly maximize timely deliverables for
                                        real-time schemas. Dramatically maintain clicks-and-mortar
                                        solutions without functional solutions. Completely synergize
                                        resource sucking relationships via premier niche markets.
                                        Professionally cultivate one-to-one customer service with
                                        robust ideas. Dynamically innovate resource-leveling customer
                                        service for state of the art customer service. Objectively
                                        innovate empowered manufactured products whereas parallel
                                        platforms.
                                    </p>
                                </div>
                                {/* <!-- end section-heading --> */}
...
================================= -->
    ...
    START FUN-FACT AREA
================================= --> */}
            <section className="funfact-area bg-gradient-gray section--padding">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item d-flex align-items-center">
                                ...
                                <div className="counter-content pl-3">
                                    ...
                                    <p className="counter__title">New Users Every Week</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                            ...
                            <div className="counter-item d-flex align-items-center">
                                ...
                                <div className="counter-content pl-3">
                                    <h3 className="counter__number text-color-4 mb-2">
                                        <span className="counter">50,100</span>
                                        <span className="count-symbol">+</span>
                                    </h3>
                                    <p className="counter__title">Customers Every Year</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item d-flex align-items-center">
                                ...
                                <div className="counter-content pl-3">
                                    ...
                                    <p className="counter__title">Awards Won</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="counter-item d-flex align-items-center">
                                ...
                                <div className="counter-content pl-3">
                                    ...
                                    <p className="counter__title">New Listing Every Week</p>
                                </div>
                                {/* <!-- end counter-content --> */}
                            </div>
                            {/* <!-- end counter-item --> */}
                    ...
                    <div className="row padding-top-60px">
                        <div className="col-lg-4 responsive-column">
                            <div className="info-box info--box js-tilt-2">
                                ...
                                <div className="info-content">
                                    <h4 className="info__title">+ 50K Customers</h4>
                                    <p className="info__desc">
                                        Proin dapibus nisl ornare diam varius ecos tempus. Aenean a
                                        quam luctus, finibus tellus
                                    </p>
                                </div>
                                {/* <!-- end info-content --> */}
                            </div>
                        ...
                        <div className="col-lg-4 responsive-column">
                            <div className="info-box info--box js-tilt-2">
                                ...
                                {/* <!-- end info-icon--> */}
                                <div className="info-content">
                                    <h4 className="info__title">H24 Support</h4>
                                    <p className="info__desc">
                                        Proin dapibus nisl ornare diam varius ecos tempus. Aenean a
                                        quam luctus, finibus tellus
                                    </p>
                        ...
                        <div className="col-lg-4 responsive-column">
                            <div className="info-box info--box js-tilt-2">
                                ...
                                {/* <!-- end info-icon--> */}
                                <div className="info-content">
                                    <h4 className="info__title">+ 6575 Locations</h4>
                                    <p className="info__desc">
                                        Proin dapibus nisl ornare diam varius ecos tempus. Aenean a
                                        quam luctus, finibus tellus
                                    </p>
                        ...
                        <div className="col-lg-4 responsive-column">
                            <div className="info-box info--box js-tilt-2">
                                ...
                                {/* <!-- end info-icon--> */}
                                <div className="info-content">
                                    <h4 className="info__title">Help Direct Line</h4>
                                    <p className="info__desc">
                                        Proin dapibus nisl ornare diam varius ecos tempus. Aenean a
                                        quam luctus, finibus tellus
                                    </p>
                        ...
                        <div className="col-lg-4 responsive-column">
                            <div className="info-box info--box js-tilt-2">
                                ...
                                {/* <!-- end info-icon--> */}
                                <div className="info-content">
                                    <h4 className="info__title">Support via Chat</h4>
                                    <p className="info__desc">
                                        Proin dapibus nisl ornare diam varius ecos tempus. Aenean a
                                        quam luctus, finibus tellus
                                    </p>
...
================================= -->
    ...
    START TEAM AREA
================================= --> */}
            <section className="team-area bg-gray section-padding">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-heading text-center">
                    ...
                    <div className="row mt-5">
                        <div className="col-lg-3 responsive-column">
                            <div className="card-item card-item-layout-2 hover-y">
                                ...
                                <div className="card-content pt-3">
                                    <h4 className="card-title mb-0"><a href="#">Kamal Ahmed</a></h4>
                                    <p className="card-sub font-size-14">Business Consultant</p>
                                    <ul className="social-profile social-profile-styled pt-4">
                                        <li>
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="card-item card-item-layout-2 hover-y">
                                ...
                                {/* <!-- end card-image --> */}
                                <div className="card-content pt-3">
                                    <h4 className="card-title mb-0"><a href="#">Kamran Ahmed</a></h4>
                                    <p className="card-sub font-size-14">Front-end developer</p>
                                    <ul className="social-profile social-profile-styled pt-4">
                                        <li>
                                            <a href="#" className="facebook-bg"
                                            ><i className="la la-facebook"></i
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="card-item card-item-layout-2 hover-y">
                                ...
                                {/* <!-- end card-image --> */}
                                <div className="card-content pt-3">
                                    <h4 className="card-title mb-0"><a href="#">Tanbir Ahmed</a></h4>
                                    <p className="card-sub font-size-14">Backend Developer</p>
                                    <ul className="social-profile social-profile-styled pt-4">
                                        <li>
                                            <a href="#" className="facebook-bg"
                                            ><i className="la la-facebook"></i
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="card-item card-item-layout-2 hover-y">
                                ...
                                {/* <!-- end card-image --> */}
                                <div className="card-content pt-3">
                                    <h4 className="card-title mb-0"><a href="#">Juhen Ahmed</a></h4>
                                    <p className="card-sub font-size-14">Director</p>
                                    <ul className="social-profile social-profile-styled pt-4">
                                        <li>
                                            <a href="#" className="facebook-bg"
                                            ><i className="la la-facebook"></i
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="btn-box pt-4">
                                <a
                                    href="#"
                                    className="theme-btn gradient-btn hover-scale"
                                    data-toggle="modal"
                                    data-target="#signUpModal"
                                >Create Your Business Listing Today
...
================================= --> */}
            <section
                className="footer-area bg-gradient-gray padding-top-30px padding-bottom-30px position-relative"
            >
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div
                                className="cta-content d-flex align-items-center justify-content-between p-0"
                            >
                                <div className="section-heading">
                                    <h2 className="sec__title mb-0 font-size-24 line-height-30">
                                        Don't miss your monthly offer
                                    </h2>
                        ...
                        <div className="col-lg-3 responsive-column">
                            <div className="footer-item">
                                ...
                                <p className="footer__desc">
                                    Morbi convallis bibendum urna ut viverra. Maecenas quis
                                    consequat libero, a feugiat eros culpa officia deserunt mollit.
                                </p>
                                <p className="footer__desc">
                                    <a href="#" className="btn-text"
                                    >View on the map <i className="la la-arrow-right icon"></i
                                    ></a>
                                </p>
                            </div>
                            {/* <!-- end footer-item --> */}
