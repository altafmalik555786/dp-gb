                        ...
                        <div className="col-lg-12">
                            <div className="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                                <div className="section-heading">
                                    <h2 className="sec__title font-size-26 mb-0">Listing Half Map List</h2>
                                </div>
                                <ul className="list-items bread-list bread-list-2 ">
                                    <li><a href="index.html">Home</a></li>
                                    <li>Listings</li>
                                    <li>Listing Half Map List</li>
                                </ul>
                            </div>
...
export default ListingHalfmapList